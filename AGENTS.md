...
**Three files get written every session.** Your own `context/progress/<agent>.md`, the build log at `docs/build-log/phase-N.md`, and nothing else outside your owned paths. Only the lead writes `context/progress-tracker.md`.
