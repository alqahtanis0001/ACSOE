...
It lives at `docs/build-log/phase-N.md`, one file per phase. It is written by the agents, as work happens, and it becomes the raw material for the dissertation's implementation chapter.
