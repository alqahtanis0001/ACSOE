...
**Triple barrier** — the labelling method. From a given bar, ask which of three lines price touches first: the profit target (+3%), the stop (−1.5%), or the timeout (24 bars). Three-class label.
