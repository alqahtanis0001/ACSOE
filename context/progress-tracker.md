...
| 3 — Economics | **In progress — opened 2026-09-10** | Specs 37–47. Spec 37 landed (the three rulings into the documents). Gate currently reports 2 PASS / 0 FAIL / 0 PENDING and **says "green" while registering nothing of substance** — spec 45 is what fixes that, and it is C's first task |
