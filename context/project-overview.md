...
Most of the system exists to say no. Eight of the twenty-three engines contain no machine learning at all — the components that protect capital are auditable arithmetic, not models anyone has to trust.
